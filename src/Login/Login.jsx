  ...
  return (
    <div>
      <div className="relative flex flex-col-reverse lg:flex-row-reverse">
        <div className="w-full h-full px-5 mt-10 xl:px-20 lg:w-3/5">
        <ShuffleGrid />
        </div>
        <div className="flex flex-col items-center w-full mt-28 lg:mt-36 lg:w-2/5">
            ...
            <div className="w-96 ">
              <form className="flex flex-col mt-4 font-roboto">
                ...
                <p className="mt-10 text-sm text-center text-gray-500">
                  ...
                  <span className="font-semibold text-gray-900 underline"><a href="">Sign Up for free</a></span>
                </p>
...
const shuffle = (array) => {
  ...
  const ShuffleGrid = () => {
    ...
    return (
      <div className="grid grid-cols-3 grid-rows-3 h-[600px] md:h-[900px] gap-2 ">
        {squares.map((sq) => sq)}
      </div>
    );
  };
